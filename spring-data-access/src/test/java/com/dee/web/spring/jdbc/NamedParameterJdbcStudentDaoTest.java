...
public class NamedParameterJdbcStudentDaoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        appCtx = new GenericXmlApplicationContext("/spring/jdbc/daosupport/app-context.xml");
        studentService = appCtx.getBean("jdbcStudentService", JDBCStudentService.class);
        
        JDBCStudentDao jdbcStudentDao = appCtx.getBean("namedParameterJdbcStudentDao", JDBCStudentDao.class);

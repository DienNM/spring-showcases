...
public class JdbcTemplateStudentDefaultDaoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        JDBCStudentDao jdbcStudentDao = appCtx.getBean("jdbcTemplateStudentDaoDefault", JDBCStudentDao.class);

...
public class JdbcTemplateRowMapperStudentDaoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        appCtx = new GenericXmlApplicationContext("/spring/jdbc/connectionpool/app-context.xml");
        studentService = appCtx.getBean("jdbcStudentService", JDBCStudentService.class);
        
        JDBCStudentDao jdbcStudentDao = appCtx.getBean("jdbcTemplateRowMapperStudentDao", JDBCStudentDao.class);
